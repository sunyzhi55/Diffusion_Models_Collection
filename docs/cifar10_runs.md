...
| 3 | Diffusion Transformer | 1.3 | 5000 | V100 32G × 8（用 2） | 128 / 1e-4 | 余弦 | 每 50 轮存模；200 轮起每 50 轮采样 16 张 | 待补充 |

---

## 1.2 UNet（Titan XP 12G × 8，用 7 张）🧠
...
| 模型 / CFG | FID | IS | LPIPS_diversity | 耗时 |
| --- | --- | --- | --- | --- |
...
## 1.3 Diffusion Mamba（V100 32G × 8，用 5 张）🐍
...
## 1.4 Diffusion Transformer（V100 32G × 8，用 2 张）🧠⚡
...
| 方法 | 采样 CFG | 步数 | 张数 | 耗时 |
| --- | --- | --- | --- | --- |
| DDIM | 3.0 | 50 | 10 类 × 每类 8 张 | 待补充 |
| DDPM | 3.0 | 1000 | 10 类 × 每类 8 张 | 待补充 |
...
| 评估 CFG | FID | IS | LPIPS_diversity | 耗时 |
| --- | --- | --- | --- | --- |
| 待补充 | 待补充 | 待补充 | 待补充 | 待补充 |
